...
`index.html` 每请求现读盘并填两个占位符:`{{TITLE}}`(`--title`,HTML 转义)与 `{{DATA_DIR}}`(页脚提示)。
...
10. 视觉:暖黑底 `#12100E`、卡 `#1C1815` 圆角 16、琥珀 `#E8B463` 强调、米白 `#F2EDE3` 正文、次要字 `#8A7F70`、通过绿 `#7FA86A`、未通过红 `#C24A33`;系统字体栈;移动优先,桌面居中限宽 560px。
